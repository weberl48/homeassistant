...
ENV_COMMON="-e BOOTLEGGER_MODE=live -e SLEEPER_LEAGUE_ID=$LEAGUE \
  ...
  -e BOOTLEGGER_LEAGUE_LABEL='Boko no Football' \n  -e BOOTLEGGER_SIBLING_PORT=8486 -e BOOTLEGGER_SIBLING_LABEL='No Punts Intended' \n  -e BOOTLEGGER_API_TOKEN=$API_TOKEN -v $DATA:/data"
...
mkdir -p "$ESPN_DATA"
ENV_ESPN="-e BOOTLEGGER_MODE=live -e BOOTLEGGER_PLATFORM=espn   -e BOOTLEGGER_LEAGUE_ID=$ESPN_LEAGUE -e BOOTLEGGER_MY_ROSTER_ID=$ESPN_ROSTER   -e BOOTLEGGER_SEASON=$SEASON -e FANTASYPROS_API_KEY=$FANTASYPROS_API_KEY    -e BOOTLEGGER_LEAGUE_LABEL='No Punts Intended' -e BOOTLEGGER_SIBLING_PORT=8484 -e BOOTLEGGER_SIBLING_LABEL='Boko no Football'  -e BOOTLEGGER_API_TOKEN=$API_TOKEN -v $ESPN_DATA:/data"
